...
public class T09PhoneBookTest {
	...
	private void insert() {
		...
		scan.nextLine(); // 입력버퍼에 남아있는 엔터키를 읽어오는 용도 / 버퍼를 비우는 역할
	...
	private void search() {
		...
		System.out.println();
		System.out.println("검색할 사람 이름을 입력하세요.");
		System.out.print("이름 >>");
		...
		if(pv == null) {
			System.out.println(name + "씨는 존재하지 않는 사용자 이름입니다.");
		}else {
