...
public class UdpFileSender {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		new UdpFileSender("192.168.145.33", 8888).start();
	...
	public UdpFileSender(String receiverIp, int port) {
		...
		try {
			...
			file = new File("D:/D_Other/spongebob.png");
	...
	public void start() throws InterruptedException {
		...
		try {
			...
			while(true) {
				Thread.sleep(10); // 패킷 전송간의 간격을 주기 위해 sleep
	...
	/**
	 * 바이트배열 데이터 전송하기
	 * @param bytes 전송할 바이트배열
	 * @param data 실제 전송할 크기
	 */
